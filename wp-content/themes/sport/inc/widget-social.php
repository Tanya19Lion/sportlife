    ...
    class SI_Widget_Social extends WP_Widget {
        public function __construct() {
            parent::__construct(
                ...
                'SI-Widget - Social', 
                [
                    'name' => 'SI-Widget - Social', 
                    'description' => 'Посилання на соцмережі'
                ]
            );
        }
...
?>
    <p>
        <label for="<?php echo $this -> get_field_id('id_link'); ?>">Посилання на соцмережу:</label>
        <input 
            id="<?php echo $this -> get_field_id('id_link'); ?>" 
            type="text" 
    ...
    <p>
        <label for="<?php echo $this -> get_field_id('id_slug'); ?>">Вибрати соцмережу:</label>
        <select 
            id="<?php echo $this -> get_field_id('id_slug'); ?>" 
