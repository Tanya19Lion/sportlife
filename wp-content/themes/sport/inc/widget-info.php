    ...
    class SI_Widget_Info extends WP_Widget {
        public function __construct() {
            parent::__construct(
                ...
                [
                    'name' => 'SI-Widget - Info', 
                    'description' => 'Детальна інформація спортклубу'
                ]
            );
        }
        ...
        public function form($instance) {
            $vars = [
                ...
                'time' => 'Години роботи',
                'phone' => 'Телефон',
                'mail' => 'Електорнна пошта',
            ];
?>
    <p>
        <label for="<?php echo $this -> get_field_id('id_info'); ?>">Текст:</label>
        <input 
    ...
    <p>
        <label for="<?php echo $this -> get_field_id('id_var'); ?>">Вибрати варіант відображення:</label>
        <select 
            id="<?php echo $this -> get_field_id('id_var'); ?>" 
