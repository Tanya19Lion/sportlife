    ...
    class SI_Widget_Contacts extends WP_Widget {
        public function __construct() {
            parent::__construct(
                ...
                'SI-Widget - Contacts', 
                [
                    'name' => 'SI-Widget - Contacts', 
                    'description' => 'Номер телефону та адреса'
                ]
            );
        }
...
?>
    <p>
        <label for="<?php echo $this -> get_field_id('id_phone'); ?>">Введіть номер телефону:</label>
        <input 
    ...
    <p>
        <label for="<?php echo $this -> get_field_id('id_address'); ?>">Введіть адресу:</label>
        <input 
